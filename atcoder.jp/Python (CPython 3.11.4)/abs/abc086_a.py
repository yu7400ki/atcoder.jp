...
class UnsizedArray:
    ...
    def __init__(self, elem):
        self.elem = elem
__percent__v_desugar_1_L1 = (list)((map)(int__,((input)()).split(Str(" "),),),)
a_L1_C1 = (__percent__v_desugar_1_L1).__getitem__(Nat(0),)
b_L1_C4 = (__percent__v_desugar_1_L1).__getitem__(Nat(1),)
ans_L3 = Str("Even") if (((a_L1_C1 * b_L1_C4) % Nat(2)) == Nat(0)) else Str("Odd")
(print)(ans_L3,)
