...
class UnsizedArray:
    ...
    def __init__(self, elem):
        self.elem = elem
a__ = (int__)((input)(),)
__percent__v_desugar_1__ = (list)((map)(int__,((input)()).split(Str(" "),),),)
b__ = (__percent__v_desugar_1__).__getitem__(Nat(0),)
c__ = (__percent__v_desugar_1__).__getitem__(Nat(1),)
s__ = (input)()
(print)(((a__ + b__) + c__),s__,)
